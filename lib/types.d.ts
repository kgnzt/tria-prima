...
declare module "types" {
   ...
   */
  export type IPageEnter = (query: IInstance.Query, api: IInstance.API) => any;
  ...
  export interface IQuery {
    params: Immutabe.Map<string, string>;
  }
  ...
  export module IInstance {
    ...
    export type Action = RecordOf<IAction>;
    ...
    export type Store = RecordOf<IStore>;
  }
}
